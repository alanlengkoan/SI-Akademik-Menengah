...
<body>
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="guru/simpan_materi.php" method="POST" enctype="multipart/form-data">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" placeholder="Judul Materi" name="ijudul" id="ijudul">
                                        </div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                     <div class="nk-int-st">
                                         ...
                                         <p>File dengan tipe (*.pdf,*.txt,*.mp4)</p>
                                     </div>
                                 </div>
                             </div>
                         </div>
