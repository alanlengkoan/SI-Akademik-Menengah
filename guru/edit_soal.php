...
session_start();
$tahun = date('Y');
$rs=$mysqli->query("select * from soal where id = '$_GET[id]'");
$data = $rs->fetch_assoc();
  ...
  $sql_mapel = "select * from mapel";
    ...
    while($data_mapel = $rs_mapel->fetch_assoc()){
       if(in_array($data_mapel[id],$mapel)){
         if($data_mapel[id]==$data[id_mapel]){
            $option .= "<option value=\"$data_mapel[id]\" selected>$data_mapel[pelajaran]</option>";
        }else{
...
<body>
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="guru/update_soal.php?id=<?php echo $_GET[id]?>" method="POST" enctype="multipart/form-data">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <textarea class="form-control" id="iuraian" name="iuraian" rows="3" placeholder="Uraian Soal"><?php echo $data[uraian_soal]?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental">
                             <div class="form-group">
                                 <div class="row">
                                     ...
                                     <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                         <div class="nk-int-st">
                                             <textarea id="ipila" name="ipila" class="form-control" rows="3" placeholder="Pilihan A"><?php echo $data[pil1]?></textarea>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="form-example-int form-horizental">
                              <div class="form-group">
                                  <div class="row">
                                      ...
                                      <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                          <div class="nk-int-st">
                                              <textarea id="ipilb" name="ipilb" class="form-control" rows="3" placeholder="Pilihan B"><?php echo $data[pil2]?></textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="form-example-int form-horizental">
                               <div class="form-group">
                                   <div class="row">
                                       ...
                                       <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                           <div class="nk-int-st">
                                               <textarea id="ipilc" name="ipilc" class="form-control" rows="3" placeholder="Pilihan C"><?php echo $data[pil3]?></textarea>
                                           </div>
                                       </div>
                                   </div>
                               </div>
                           ...
                           <div class="form-example-int form-horizental">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <textarea id="ipild" name="ipild" class="form-control" rows="3" placeholder="Pilihan D"><?php echo $data[pil4]?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-example-int form-horizental">
                                 <div class="form-group">
                                     <div class="row">
                                         ...
                                         <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                             <div class="nk-int-st">
                                                 <textarea id="ipile" name="ipile" class="form-control" rows="3" placeholder="Pilihan E"><?php echo $data[pil5]?></textarea>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
    ...
    $(document).ready(function(){
        ...
        $('#ijenis').val('<?php echo $data[jenis_soal]?>')
        $('#ijawaban').val('<?php echo $data[jawaban_pil]?>')
        $('#igrup').val('<?php echo $data[id_grup]?>')
    })
    </script>
</body>
