                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="mybox ">
                     <div class="bsc-tbl">
                        ...
                        <a href='index.php?mode=tambah_jadwal1' class="btn btn-primary primary-icon-notika btn-icon-notika notika-btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                         <hr>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sql = "
                                    SELECT jadwal_materi.`id`,kelas.nama,materi.judul,mapel.pelajaran,jadwal_materi.tgl_tayang_awal,jadwal_materi.tgl_tayang_akhir FROM `jadwal_materi` 
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <div class=\"button-icon-btn button-icon-btn-cl\">
                                             <a href='index.php?mode=edit_jadwal1&id=$data[id]' class=\"btn btn-primary primary-icon-notika btn-reco-mg btn-button-mg\"><i class=\"fa fa-pencil\"></i></a>
    ...
    $('.hapus').on('click', function(){
        var idx = $(this).attr("id");
            swal({
                ...
                window.location=('guru/hapus_jadwal1.php?id='+idx);
            });
        });
    </script>
</body>
