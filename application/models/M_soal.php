...
class M_soal extends CI_Model
{
    ...
    {
        $result = $this->db->query("SELECT soal.id_soal, soal.id_guru, soal.time, soal.nilai, mapel.nama, ujian_jenis.jenis AS jenis_ujian FROM soal LEFT JOIN mapel ON soal.id_mapel = mapel.id_mapel LEFT JOIN ujian_jenis ON soal.id_ujian_jenis = ujian_jenis.id_ujian_jenis")->result();
        return $result;
    }
