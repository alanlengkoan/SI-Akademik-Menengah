                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="mybox ">
                     <div class="bsc-tbl">
                        ...
                        <a href='index.php?mode=tambah_kelas' class="btn btn-primary primary-icon-notika btn-icon-notika notika-btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                         <hr>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sql = "SELECT kelas.*,guru.nama as nama_guru FROM `kelas` INNER JOIN guru ON kelas.walikelas=guru.id";
                                    $rs = $mysqli->query($sql);
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <div class=\"button-icon-btn button-icon-btn-cl\">
                                             <a href='index.php?mode=edit_kelas&id=$data[id]' class=\"btn btn-primary primary-icon-notika btn-reco-mg btn-button-mg\"><i class=\"fa fa-pencil\"></i></a>
    ...
    $('.hapus').on('click', function(){
        var idx = $(this).attr("id");
            swal({   
                ...
                window.location=('admin/hapus_kelas.php?id='+idx);
            });
        });
    </script>
</body>
