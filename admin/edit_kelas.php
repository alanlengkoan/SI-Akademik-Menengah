<?php
     $tahun = date('Y');
     $rs_guru=$mysqli->query("select * from kelas where id = '$_GET[id]'");
     
     $data_guru = $rs_guru->fetch_assoc();
     
      $sql_mapel = "select * from guru";
   ...
   <!-- Mobile Menu start -->
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="admin/update_kelas.php" method="POST" >
                      ...
                      <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input value="<?php echo $data_guru[nama]?>" type="text" class="form-control input-sm" placeholder="Nama kelas" name="inama" id="inama">
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <select class="selectpicker" id="iwalikelas" name="iwalikelas">
                                               <?php
    ...
    $(document).ready(function(){
        $('#iwalikelas').val('<?php echo $data_guru[walikelas]?>');
    })
    </script>
</body>
