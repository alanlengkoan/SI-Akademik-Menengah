...
<body>
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="admin/simpan_siswa.php" method="POST" >
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" placeholder="Nomor Induk Siswa" name="inis" id="inis">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" placeholder="Nama Siswa" name="inama" id="inama">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" placeholder="Tempat Lahir" name="itempat_lahir" id="itempat_lahir">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="input-group date nk-int-st">
                                           <input  name="itgl_lahir" type="text" class="mydate form-control" value="" placeholder="Tanggal Lahir">
                                       </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                           <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" placeholder="Nama Orang Tua/ Wali" name="iortu_wali" id="ortu_wali">
                                        </div>
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="form-example-int form-horizental mg-t-15">
                           <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control input-sm" placeholder="Alamat" name="ialamat" id="alamat">
                                        </div>
                                    </div>
                                </div>
                            </div>
