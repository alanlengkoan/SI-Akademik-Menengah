                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Charts" class="tab-pane notika-tab-menu-bg animated flipInX">
                         ...
                         <div id="userx" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="#">Ganti Password</a>
                                </li>
                                <li><a href="#">Keluar</a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="mybox mg-t-30">
                     <div class="bsc-tbl">
                        ...
                        <button class="btn btn-primary btn-icon-notika"><i class="fa fa-plus"></i> Tambah</button>
                        </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <div class="button-icon-btn button-icon-btn-cl">
                                             <a href='#' class="btn btn-primary primary-icon-notika btn-reco-mg btn-button-mg"><i class="fa fa-pencil"></i></a>
                                              <a href='#' class="btn btn-danger danger-icon-notika btn-reco-mg btn-button-mg"><i class="fa fa-trash"></i></a>   
                                            </div>    
                                        </td>
                                    </tr>
                                </tbody>
