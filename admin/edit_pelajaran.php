<?php
     $tahun = date('Y');
     $rs_guru=$mysqli->query("select * from mapel where id = '$_GET[id]'");
   ...
   <!-- Mobile Menu start -->
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="admin/update_pelajaran.php" method="POST" >
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input value="<?php echo $data_guru[pelajaran]?>" type="text" class="form-control input-sm" placeholder="Mata Pelajaran" name="inama" id="inama">
                                        </div>
                                    </div>
                                </div>
                            </div>
