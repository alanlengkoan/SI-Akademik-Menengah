                            ...
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#user" href="#">Pengguna</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                        <li><a href="index.php?mode=daftar_user">Daftar User</a>
                                        </li>
                                        ...
                                        <div class="nk-int-st">
                                           <div class="bootstrap-select fm-cmp-mg">
                                                <select class="selectpicker">
                                                         <option value="0">Semuanya Kelas</option>
                                                        <?php
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="mybox mg-t-30">
                     <div class="bsc-tbl">
                        ...
                        <a href='index.php?mode=tambah_siswa' class="btn btn-primary primary-icon-notika btn-icon-notika notika-btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                         <hr>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sql = "SELECT siswa.*,kelas.nama as nama_kelas FROM `siswa` INNER JOIN kelas ON siswa.id_kelas=kelas.id";
                                    $rs = $mysqli->query($sql);
                                    while($data = $rs->fetch_assoc()){
                                     ...
                                     echo "
                                      <tr>
                                        ...
                                        <td>$data[ortu_wali]</td>
                                        <td>
                                            <div class=\"button-icon-btn button-icon-btn-cl\">
                                             <a href='index.php?mode=edit_siswa&id=$data[id]' class=\"btn btn-primary primary-icon-notika btn-reco-mg btn-button-mg\"><i class=\"fa fa-pencil\"></i></a>
    ...
    $('.hapus').on('click', function(){
        var idx = $(this).attr("id");
            swal({   
                ...
                window.location=('admin/hapus_siswa.php?id='+idx);
            });
        });
    </script>
</body>
