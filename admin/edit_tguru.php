<?php
    ...
    while($data_guru1 = $rs_guru1->fetch_assoc()){
            $option3 .= "<option value=\"$data_guru1[id]\">$data_guru1[nama]</option>"; 
        }
?>
<!doctype html>
   ...
   <!-- Mobile Menu start -->
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="admin/update_tguru.php" method="POST" >
    ...
    $(document).ready(function(){
        ...
        $('#iguru').val('<?php echo $data_guru[id_guru]?>')
        $('#ipelajaran').val('<?php echo $data_guru[id_mapel]?>')
    })
    </script>
</body>
