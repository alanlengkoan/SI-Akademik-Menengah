                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="mybox ">
                     <div class="bsc-tbl">
                        ...
                        <a href='index.php?mode=tambah_pelajaran' class="btn btn-primary primary-icon-notika btn-icon-notika notika-btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                         <hr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <div class=\"button-icon-btn button-icon-btn-cl\">
                                             <a href='index.php?mode=edit_pelajaran&id=$data[id]' class=\"btn btn-primary primary-icon-notika btn-reco-mg btn-button-mg\"><i class=\"fa fa-pencil\"></i></a>
    ...
    $('.hapus').on('click', function(){
        var idx = $(this).attr("id");
            swal({   
                ...
                window.location=('admin/hapus_pelajaran.php?id='+idx);
            });
        });
    </script>
</body>
