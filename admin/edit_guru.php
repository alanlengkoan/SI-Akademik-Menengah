<?php
     $tahun = date('Y');
     $rs_guru=$mysqli->query("select * from guru where id = '$_GET[id]'");
     
     $data_guru = $rs_guru->fetch_assoc();
     
     $rs_user = $mysqli->query("select * from users where level = '2' and idlevel is NULL");
   ...
   <!-- Mobile Menu start -->
    ...
    <div class="normal-table-area">
        <div class="container">
             ...
             <div class="row">
                 <form action="admin/update_guru.php" method="POST" >
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input value='<?php echo $data_guru[nama]?>' type="text" class="form-control input-sm" placeholder="Nama Guru" name="inama" id="inama">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                           <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input value='<?php echo $data_guru[nip]?>' type="text" class="form-control input-sm" placeholder="Nip atau No. Induk Guru" name="inip" id="inip">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                           <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input value='<?php echo $data_guru[pendidikan]?>'  type="text" class="form-control input-sm" placeholder="Pendidikan Guru" name="ipendidikan" id="ipendidikan">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            ...
                                            <input value='<?php echo $data_guru[thn_masuk]?>'  type="number" class="form-control input-sm" placeholder="Tahun Masuk Menjadi Guru" name="ithn_masuk" id="ithn_masuk" value="<?php echo $tahun ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function(){
        $('#iuser').val('<?php echo $data_guru[iduser]?>')
    })
    </script>
</body>
